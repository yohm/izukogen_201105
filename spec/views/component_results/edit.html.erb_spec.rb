...
describe "component_results/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit component_result form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => component_results_path(@component_result), :method => "post" do
